 ...
 *
 * @phpstan-method        Proxy<Student> create(array|callable $attributes = [])
 * @phpstan-method static Proxy<Student> createOne(array $attributes = [])
 * @phpstan-method static Proxy<Student> find(object|array|mixed $criteria)
 * @phpstan-method static Proxy<Student> findOrCreate(array $attributes)
 * @phpstan-method static Proxy<Student> first(string $sortedField = 'id')
 * @phpstan-method static Proxy<Student> last(string $sortedField = 'id')
 * @phpstan-method static Proxy<Student> random(array $attributes = [])
 * @phpstan-method static Proxy<Student> randomOrCreate(array $attributes = [])
 * @phpstan-method static RepositoryProxy<Student> repository()
 * @phpstan-method static list<Proxy<Student>> all()
 * @phpstan-method static list<Proxy<Student>> createMany(int $number, array|callable $attributes = [])
 * @phpstan-method static list<Proxy<Student>> createSequence(iterable|callable $sequence)
 * @phpstan-method static list<Proxy<Student>> findBy(array $attributes)
 * @phpstan-method static list<Proxy<Student>> randomRange(int $min, int $max, array $attributes = [])
 * @phpstan-method static list<Proxy<Student>> randomSet(int $number, array $attributes = [])
 */
